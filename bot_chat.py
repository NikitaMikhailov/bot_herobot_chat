...
def goroscop1():
    ...
    for i in range (0,12):
        ...
        filegor.write(((bs4.BeautifulSoup(requests.get("http://astroscope.ru/horoskop/ejednevniy_goroskop/" + spisok_znakov[i] + ".html").text.decode('utf-8'),"html.parser").find('div', 'col-12')).getText().lstrip()))
        filegor.close()
